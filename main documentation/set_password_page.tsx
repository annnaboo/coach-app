...
export default function SetPasswordPage() {
  ...
  useEffect(() => {
    ...
    // Слушаем событие от инвайт-ссылки или recovery-токена.
    // НЕ используем getSession() — она вернёт сессию тренера если он залогинен
    // в том же браузере, что подменит аккаунт.
