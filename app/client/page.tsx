        ...
        <div style={{ maxWidth: '460px', margin: '0 auto' }}>
          ...
          <div className="card-enter" style={{ ...card }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
              ...
              <button onClick={saveMood} disabled={moodLoading} style={{ padding: '5px 14px', borderRadius: '999px', background: moodSaved ? 'var(--accent-soft-bg)' : 'var(--accent-primary)', color: moodSaved ? 'var(--accent-primary)' : 'var(--text-inverse)', border: moodSaved ? '1px solid rgba(0,0,0,0.06)' : 'none', fontFamily: 'var(--font-text)', fontSize: '11px', cursor: 'pointer' }}>
              ...
              <>
                ...
                {program && (
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px', marginBottom: '14px', marginTop: '2px' }}>
                    <span style={{ display: 'inline-flex', background: 'var(--accent-soft-bg)', border: '1px solid rgba(0,0,0,0.06)', borderRadius: '999px', padding: '3px 12px', fontSize: '11px', color: 'var(--accent-primary)', fontFamily: 'var(--font-text)', fontWeight: 300 }}>
                      📋 {program.title}
                    </span>
                    {program.start_date && (
                ...
                {todayWorkout.exercises && todayWorkout.exercises.length > 0 && (
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px', marginBottom: '20px' }}>
                    {todayWorkout.exercises.slice(0, 4).map((ex: any, i: number) => (
                      <span key={i} style={{ fontFamily: 'var(--font-text)', fontWeight: 300, fontSize: '11px', color: 'var(--accent-primary)', background: 'var(--accent-soft-bg)', border: '1px solid var(--accent-soft-bg)', borderRadius: '999px', padding: '3px 10px' }}>
                        {ex.name}
                      </span>
                    ))}
              ...
              top3.map(([exId, weight]) => (
                <div key={exId} style={{ marginBottom: '20px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                    <span style={{ fontFamily: 'var(--font-text)', fontWeight: 300, fontSize: '13px', color: 'var(--text-secondary)' }}>{exerciseNameMap[exId] || EXERCISE_NAMES[exId] || exId}</span>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginTop: '24px' }}>
            <button onClick={() => router.push('/reports-history')} style={{ padding: '10px 24px', borderRadius: '999px', background: 'var(--accent-soft-bg)', border: '1px solid rgba(0,0,0,0.06)', color: 'var(--accent-primary)', fontFamily: 'var(--font-text)', fontWeight: 300, fontSize: '12px', cursor: 'pointer' }}>
              Мои отчёты →
            </button>
          </div>
